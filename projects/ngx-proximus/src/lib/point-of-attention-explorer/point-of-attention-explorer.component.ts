...
@Component({
  selector: 'pxs-point-of-attention-explorer',
  templateUrl: './point-of-attention-explorer.component.html',
  styleUrls: ['./point-of-attention-explorer.component.scss']
})
export class PointOfAttentionExplorerComponent extends LocationExplorerComponent implements OnInit, OnDestroy {
