...
@Component({
  selector: 'pvf-walkingtrails-map',
...
export class WalkingTrailsMapComponent extends MapComponent implements OnInit, OnChanges {
  ...
  createAssetPopup(asset: IPeopleCountingAsset, assetUrl: string, marker: Marker): any {
    const popupEl: NgElement & WithProperties<WalkingTrailsMapPopupComponent> =
      document.createElement('walkingtrails-map-popup-element') as any;
