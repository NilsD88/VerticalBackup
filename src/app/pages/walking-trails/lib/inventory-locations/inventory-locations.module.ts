...
import { WalkingTrailsInventoryLocationsRoutes } from './inventory-locations.routing';
import { WalkingTrailsInventoryLocationsComponent } from './inventory-locations.component';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(WalkingTrailsInventoryLocationsRoutes),
    FormsModule,
    ReactiveFormsModule,
    NgxMatDrpModule,
    TranslateModule,
  ...
  declarations: [WalkingTrailsInventoryLocationsComponent],
  exports: [WalkingTrailsInventoryLocationsComponent]
})
export class WalkingTrailsInventoryLocationsModule {
}
