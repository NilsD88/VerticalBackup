...
export const WalkingTrailsRoutes: Routes = [
  {
    path: '',
  ...
  },
  {
    ...
    children: [{
      path: '',
      loadChildren: () => import('./lib/inventory-locations/inventory-locations.module').then(m => m.WalkingTrailsInventoryLocationsModule)
    }]
  }
];
