...
import { WalkingTrailInventoryLocationsRoutes } from './inventory-locations.routing';
import { WalkingTrailInventoryLocationsComponent } from './inventory-locations.component';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(WalkingTrailInventoryLocationsRoutes),
    FormsModule,
    ReactiveFormsModule,
    NgxMatDrpModule,
    TranslateModule,
  ...
  declarations: [WalkingTrailInventoryLocationsComponent],
  exports: [WalkingTrailInventoryLocationsComponent]
})
export class WalkingTrailInventoryLocationsModule {
}
