...
import { SmartTankAssetWizardComponent } from './asset-wizard.component';
import { RouterModule} from '@angular/router';
import { SmartTankAssetWizardRoutes} from './asset-wizard.routing';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild(SmartTankAssetWizardRoutes),
    TranslateModule
  ],
  exports: [SmartTankAssetWizardComponent],
  entryComponents: [
    LocationWizardDialogComponent,
    ManageThresholdTemplatesDialogComponent,
  ]
})
export class SmartTankAssetWizardModule { }
