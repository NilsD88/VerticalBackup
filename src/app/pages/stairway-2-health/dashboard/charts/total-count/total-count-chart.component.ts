...
@Component({
  selector: 'pvf-stairway2health-dashboard-total-count-chart',
          ...
          point: {
            events: {
              click: function (event) {
                ...
                instance.router.navigateByUrl(`/private/stairway-2-health/place/${locationId}`);
              }
            }
          }
        }
