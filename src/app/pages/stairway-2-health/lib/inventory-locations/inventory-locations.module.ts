...
import { Stairway2HealthInventoryLocationsRoutes } from './inventory-locations.routing';
import { Stairway2HealthInventoryLocationsComponent } from './inventory-locations.component';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(Stairway2HealthInventoryLocationsRoutes),
    FormsModule,
    ReactiveFormsModule,
    NgxMatDrpModule,
    TranslateModule,
  ...
  declarations: [Stairway2HealthInventoryLocationsComponent],
  exports: [Stairway2HealthInventoryLocationsComponent]
})
export class Stairway2HealthInventoryLocationsModule {
}
